	...
	:Component(o)
{
	...
	glm::vec4 uiScreenScale =  owner->GetRootNode()->GetComponent<TransformComponent>()->GetVMatrix() * glm::vec4(owner->GetRootNode()->GetComponent<TransformComponent>()->GetScale(), 1.0f);
